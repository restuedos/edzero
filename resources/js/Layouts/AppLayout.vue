                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                ...
                                <JetNavLink :href="route('portfolios')" :active="route().current('portfolios')">
                                    Portfolios
                                </JetNavLink>
                                <JetNavLink :href="route('testimonials')" :active="route().current('testimonials')">
                                    Testimonials
                                </JetNavLink>
                            </div>
                        </div>
                            ...
                            <div class="ml-3 relative">
                                <JetDropdown align="right" width="48">
                                    ...
                                    <template #content>
                                        ...
                                        <JetDropdownLink :href="route('welcome')">
                                            Home
                                        </JetDropdownLink>
                                        ...
                                        <JetDropdownLink :href="route('layouts')">
                                            Layouts
                                        </JetDropdownLink>
